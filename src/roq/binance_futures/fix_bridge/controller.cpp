...
#include "roq/binance_futures/fix_bridge/controller.hpp"
...
auto create_bridge(auto &handler, auto &settings) {
  auto options = fix::bridge::Manager::Options{
      // session
      .comp_id = settings.fix_bridge.comp_id,
      .logon_timeout = utils::safe_cast(settings.fix_bridge.logon_timeout),
      .logon_heartbeat_min = utils::safe_cast(settings.fix_bridge.logon_heartbeat_min),
      .logon_heartbeat_max = utils::safe_cast(settings.fix_bridge.logon_heartbeat_max),
      .heartbeat_freq = utils::safe_cast(settings.fix_bridge.heartbeat_freq),
      // market data
      .top_of_book_from_market_by_price = settings.fix_bridge.top_of_book_from_market_by_price,
      .default_values = {},
      .statistics = {},
      // order management
      .route_by_strategy = settings.fix_bridge.route_by_strategy,
      .strict_checking = settings.fix_bridge.strict_checking,
      .disable_req_id_validation = settings.fix_bridge.disable_req_id_validation,
      .cxl_rej_reason_mapping = {},
      // test:
      // - market data
      .test_md_entry_position_no = {},
      .test_init_missing_md_entry_type_to_zero = {},
      // - order management
      .test_request_latency = {},
      .test_terminate_on_timeout = {},
      .test_silence_non_final_order_ack = {},
      .test_skip_order_download = {},
      // - other
      .test_terminate_on_disconnect = {},
      .test_block_client_on_not_ready = settings.fix_bridge.test_request_latency,
...
void Controller::operator()(Trace<fix::codec::ExecutionReport> const &event) {
  if (shared_.settings.fix_bridge.route_by_strategy) {
