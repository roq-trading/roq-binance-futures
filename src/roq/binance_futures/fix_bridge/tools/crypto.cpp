...
Crypto::Crypto(std::string_view const &auth_method, std::chrono::nanoseconds timestamp_tolerance)
    : method_{parse_method(auth_method)}, timestamp_tolerance_{timestamp_tolerance} {
