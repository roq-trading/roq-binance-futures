...
void DropCopyPortfolio::operator()(Trace<protocol::json::AccountUpdate> const &event) {
...
void DropCopyPortfolio::operator()(Trace<protocol::json::MarginCall> const &event) {
...
void DropCopyPortfolio::operator()(Trace<protocol::json::StrategyUpdate> const &event) {
...
void DropCopyPortfolio::operator()(Trace<protocol::json::GridUpdate> const &event) {
...
void DropCopyPortfolio::operator()(Trace<protocol::json::AccountConfigUpdate> const &event) {
...
void DropCopyPortfolio::operator()(Trace<protocol::json::TradeLite> const &event) {
  profile_.trade_lite([&]() {
...
void DropCopyPortfolio::operator()(Trace<protocol::json::ExecutionReport2> const &event) {
...
void DropCopyPortfolio::operator()(Trace<protocol::json::LiabilityChange> const &event) {
