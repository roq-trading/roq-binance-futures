...
OrderEntryClassic::OrderEntryClassic(Handler &handler, io::Context &context, uint16_t stream_id, Account &account, Shared &shared, Request &request)
...
void OrderEntryClassic::operator()(metrics::Writer &writer) const {
  writer
      // counter
...
void OrderEntryClassic::operator()(Trace<web::rest::Client::Connected> const &) {
...
void OrderEntryClassic::operator()(Trace<web::rest::Client::Disconnected> const &) {
  ++counter_.disconnect;
...
void OrderEntryClassic::operator()(Trace<web::rest::Client::Latency> const &event) {
...
void OrderEntryClassic::operator()(Trace<web::rest::Client::MessageBegin> const &) {
  shared_.rate_limits.clear();
}

void OrderEntryClassic::operator()(Trace<web::rest::Client::Header> const &event) {
...
void OrderEntryClassic::operator()(Trace<web::rest::Client::MessageEnd> const &event) {
...
void OrderEntryClassic::get_listen_key() {
  profile_.listen_key([&]() {
    auto headers = account_.get_rest_headers();
    auto request = web::rest::Request{
        .method = web::http::Method::POST,
        .path = shared_.api.simple.listen_key,
        .query = {},
...
void OrderEntryClassic::operator()(Trace<protocol::json::ListenKeyAck> const &event) {
...
void OrderEntryClassic::operator()(Trace<protocol::json::AccountBalanceAck> const &event) {
  ...
  for (auto &item : account_balance_ack.data) {
    ...
    auto funds_update = FundsUpdate{
        ...
        .hold = hold,
        .borrowed = NaN,
        .unrealized_pnl = protocol::json::get_unrealized_pnl(item.um_unrealized_pnl, item.cm_unrealized_pnl),
        .external_account = {},
...
void OrderEntryClassic::operator()(Trace<protocol::json::AccountStatusAck> const &event) {
...
void OrderEntryClassic::get_open_orders() {
...
void OrderEntryClassic::operator()(Trace<protocol::json::OpenOrdersAck> const &event) {
...
void OrderEntryClassic::get_trades() {
  profile_.trades([&]() {
...
void OrderEntryClassic::operator()(Trace<protocol::json::TradesAck> const &event) {
...
void OrderEntryClassic::refresh_listen_key() {
  if (!ready()) {
    return;
  }
  auto now = clock::get_system();
...
void OrderEntryClassic::order_place(
  ...
  profile_.order_place([&]() {
    ...
    auto recv_window = std::chrono::duration_cast<std::chrono::milliseconds>(shared_.settings.rest.order_recv_window);
    auto body =
        protocol::json::Encoder::order_place_url(encode_buffer_, create_order, order, ref_data, request_id, recv_window, shared_.api.self_trade_prevention);
...
void OrderEntryClassic::operator()(Trace<protocol::json::OrderPlaceAck> const &event, uint8_t user_id, uint64_t order_id, uint32_t version) {
...
void OrderEntryClassic::order_modify(
  ...
  profile_.order_modify([&]() {
    ...
    auto recv_window = std::chrono::duration_cast<std::chrono::milliseconds>(shared_.settings.rest.order_recv_window);
    auto body = protocol::json::Encoder::order_modify_url(
...
void OrderEntryClassic::operator()(Trace<protocol::json::OrderModifyAck> const &event, uint8_t user_id, uint64_t order_id, uint32_t version) {
...
void OrderEntryClassic::order_cancel(
  ...
  profile_.order_cancel([&]() {
    ...
    auto recv_window = std::chrono::duration_cast<std::chrono::milliseconds>(shared_.settings.rest.order_recv_window);
    auto body = protocol::json::Encoder::order_cancel_url(encode_buffer_, cancel_order, order, ref_data, request_id, previous_request_id, recv_window);
    auto query = account_.create_rest_signature_body(body);
    auto headers = account_.get_rest_headers();
    auto request = web::rest::Request{
...
void OrderEntryClassic::order_cancel_ack(Trace<web::rest::Response> const &event, uint8_t user_id, uint64_t order_id, uint32_t version) {
  profile_.order_cancel_ack([&]() {
    ...
    auto handle_success = [&](auto &body) {
      ...
      if (order_cancel_ack.status == protocol::json::OrderStatus::FILLED) {
...
void OrderEntryClassic::operator()(Trace<protocol::json::OrderCancelAck> const &event, uint8_t user_id, uint64_t order_id, uint32_t version) {
...
void OrderEntryClassic::operator()(Trace<protocol::json::OpenOrdersCancelAllAck> const &event, std::string_view const &request_id) {
...
void OrderEntryClassic::countdown_cancel_all() {
  profile_.countdown_cancel_all([&]() {
    for (auto &symbol : open_orders_symbols_) {
      ...
      auto recv_window = std::chrono::duration_cast<std::chrono::milliseconds>(shared_.settings.rest.order_recv_window);
      auto body = protocol::json::Encoder::countdown_cancel_open_orders_url(encode_buffer_, symbol, countdown_time, recv_window);
      auto query = account_.create_rest_signature_body(body);
      auto headers = account_.get_rest_headers();
      auto request = web::rest::Request{
          .method = web::http::Method::POST,
          .path = shared_.api.simple.countdown_cancel_all,
          .query = query,
          .accept = web::http::Accept::APPLICATION_JSON,
          .content_type = web::http::ContentType::APPLICATION_X_WWW_FORM_URLENCODED,
          .headers = headers,
...
void OrderEntryClassic::operator()(Trace<protocol::json::CountdownCancelAllAck> const &event) {
...
void OrderEntryClassic::process_response(web::rest::Response const &response, auto error_handler, auto success_handler) {
  try {
...
void OrderEntryClassic::operator()(Trace<server::oms::OrderUpdate> const &event, std::string_view const &client_order_id) {
...
void OrderEntryClassic::waf_limit_violation() {
