...
#include "roq/binance_futures/proto_bridge/application.hpp"
...
auto const INFO = roq::Service::Info{
    .description = "Roq's Binance futures gateway (Protobuf interface)"sv,
...
int main(int argc, char **argv) {
  ...
  return roq::binance_futures::proto_bridge::Application{args, settings, INFO}.run();
}
